...
import { Frequency, GroupType, type KixikilaGroup, type User as UserType, type AppScreen } from './types';
...
const MOCK_GROUPS: KixikilaGroup[] = [
  {
    id: '1',
    ...
    description: 'Grupo focado em poupança rápida diária para pequenos investimentos.',
  ...
  },
  {
    ...
    description: 'Kixikila de alto valor para capital de giro empresarial.',
    type: GroupType.NORMAL,
    verified: true,
    status: 'Aberto'
  },
  {
    ...
    description: 'Preparação para as festas de fim de ano com segurança.',
    type: GroupType.NORMAL,
    status: 'Aberto'
  },
  {
    ...
    description: 'Grupo focado em grandes investimentos imobiliários anuais.',
    type: GroupType.NORMAL,
    verified: true,
    status: 'Cheio'
  }
...
export default function App() {
  ...
  const validateField = (name: string, value: string) => {
    ...
    switch (name) {
      ...
      case 'phone':
        return /^9\d{8}$/.test(value) ? "" : "Telemóvel deve ter 9 dígitos e começar com 9";
      case 'bi_number':
        return /^\d{9}[A-Z]{2}\d{3}$/.test(value) ? "" : "Formato inválido (ex: 000000000LA000)";
      case 'pin':
  ...
  const completeSignup = () => {
    setIsVerifying(false);
    setSignupStep(1);
    setUser({ name: 'Samuel Quifi', email: 'quifisamuel@gmail.com', balance: 0 });
    setScreen('DASHBOARD');
  };
  ...
  const renderTerms = () => (
    <div className="min-h-screen flex flex-col bg-[#1A1A1A] text-white p-8 pt-20">
      ...
      >
        ...
        <h1 className="text-3xl font-black mb-6 leading-tight text-center">Termos e Políticas de Funcionamento</h1>
        ...
        <div className="space-y-4 mb-8">
          ...
          <button 
            onClick={() => {
              alert("Para utilizar a aplicação Kixikila Digital, é necessário aceitar os termos de funcionamento.");
            }}
    ...
    <div className="min-h-screen flex flex-col bg-[#F5F2ED]">
       <div className="p-8 pt-12 flex-1 max-w-md mx-auto w-full">
        <div className="flex items-center mb-8">
          <button onClick={() => setScreen('SPLASH')} className="p-2 bg-white rounded-full shadow-sm border border-black/5">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <h1 className="text-4xl font-black text-[#1A1A1A] mb-2 leading-tight text-center">Bem-vindo à nossa Banda!</h1>
          <p className="text-slate-500 font-medium text-center">Preenche os teus dados para entrar na tua conta.</p>
        </div>
        
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="bg-white p-6 rounded-3xl border border-black/5 shadow-sm">
              <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Email ou Telemóvel</label>
              <input 
                name="identifier"
                type="text" 
                required
            ...
            <div className="bg-white p-6 rounded-3xl border border-black/5 shadow-sm">
              <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Palavra-passe</label>
              <input 
                name="password"
                type="password" 
                required
        ...
        <p className="mt-8 text-center text-sm font-bold text-slate-500">
          Ainda não é Mano? <button onClick={() => setScreen('SIGNUP')} className="text-[#F23030] font-black hover:underline">Cadastrar aqui</button>
        </p>
      </div>
  ...
  const renderSignup = () => {
    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#F5F2ED]">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            {!isBusinessSignup ? (
              <>
                {signupStep === 1 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Dados Pessoais</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nome Completo</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nascimento</label>
                      ...
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Sexo</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nº do Bilhete (BI)</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Emissão</label>
                      ...
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nacionalidade</label>
                ...
                {signupStep === 2 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Dados de Contacto</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Telemóvel</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Email</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Endereço Residencial</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Município</label>
                      ...
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Província</label>
                ...
                {signupStep === 3 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Dados Profissionais</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Profissão</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Local de Trabalho</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Tempo de Serviço</label>
                      ...
                      <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                        <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Renda Mensal (Kz)</label>
                ...
                {signupStep === 4 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Dados Bancários</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Banco</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nº de Conta ou IBAN</label>
                ...
                {signupStep === 5 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Acesso e Finalização</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Palavra-passe</label>
                      <input type="password" required value={formData.password || ''} onChange={(e) => updateFormData('password', e.target.value)} className="w-full font-bold focus:outline-none no-animation-input" placeholder="••••••••" minLength={8} />
                    </div>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Confirmar Palavra-passe</label>
                      ...
                      {formData.password && formData.confirm_password && formData.password !== formData.confirm_password && <p className="text-[9px] text-red-500 mt-1 font-bold">As senhas não coincidem</p>}
                    </div>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">PIN de Segurança (4 dígitos)</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm flex items-center gap-3">
                      ...
                      <p className="text-[10px] font-medium text-slate-600">
                        Aceito os <button type="button" onClick={() => setShowTermsModal(true)} className="text-[#F23030] font-black hover:underline">Termos e Condições</button> e a <span className="text-[#F23030] font-black">Política de Privacidade</span>.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <>
                {signupStep === 1 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Informações Institucionais</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Nome da Empresa</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Tipo de Empresa</label>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">NIF da Empresa</label>
                ...
                {signupStep === 2 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Contactos</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Telefone</label>
                      <input type="tel" required value={formData.phone || ''} onChange={(e) => updateFormData('phone', e.target.value)} className="w-full font-bold focus:outline-none no-animation-input" placeholder="9xx xxx xxx" />
                    </div>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Email Institucional</label>
                ...
                {signupStep === 3 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Dados Financeiros</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Banco</label>
                ...
                {signupStep === 4 && (
                  <div className="space-y-4">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Acesso</h3>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Palavra-passe</label>
                      <input type="password" required value={formData.password || ''} onChange={(e) => updateFormData('password', e.target.value)} className="w-full font-bold focus:outline-none no-animation-input" placeholder="••••••••" minLength={8} />
                    </div>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm">
                      <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">PIN de Segurança</label>
                      <input type="password" maxLength={4} required value={formData.pin || ''} onChange={(e) => updateFormData('pin', e.target.value)} className="w-full font-bold focus:outline-none no-animation-input" placeholder="••••" />
                    </div>
                    <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-sm flex items-center gap-3">
                      <input type="checkbox" required className="w-5 h-5 accent-[#F23030]" />
                      <p className="text-[10px] font-medium text-slate-600">
                        Aceitamos os <button type="button" onClick={() => setShowTermsModal(true)} className="text-[#F23030] font-black hover:underline">Termos e Condições</button> da plataforma.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="bg-[#D9A441]/10 p-5 rounded-3xl border border-[#D9A441]/20 flex gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-600 leading-relaxed font-medium">Os teus dados são encriptados e nunca partilhados. Kixikila Digital é construída sobre a confiança.</p>
              </div>
            </div>
        ...
        <Modal isOpen={showTermsModal} onClose={() => setShowTermsModal(false)} title="Termos e Condições">
  ...
  const renderCreateGroup = () => (
    <div className="p-8 max-w-2xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-12">
        <button onClick={() => setScreen('DASHBOARD')} className="p-3 bg-white rounded-2xl shadow-sm border border-black/5">
          <X size={24} />
        </button>
      ...
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
          <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-4">Nome do Círculo</label>
          <input type="text" className="w-full text-xl font-black focus:outline-none no-animation-input" placeholder="Ex: Kixikila da Família" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
            <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-4">Contribuição</label>
            <div className="flex items-center gap-2">
              <input type="number" className="w-full text-xl font-black focus:outline-none no-animation-input" placeholder="0" />
              <span className="font-black text-slate-400">Kz</span>
            </div>
          </div>
          <div className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
            <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-4">Frequência</label>
        ...
        <div className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
          <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-4">Tipo de Kixikila</label>
          <div className="grid grid-cols-1 gap-3">
            <button className="p-4 rounded-2xl border-2 border-[#F23030] bg-red-50 text-[#F23030] font-black text-xs uppercase tracking-widest">Normal</button>
          </div>
        </div>
      ...
      <div className="p-8 max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-[#D9A441] p-8 rounded-[40px] shadow-xl">
            <p className="text-[10px] font-black uppercase tracking-widest opacity-60 mb-2">Saldo Actual</p>
            <h3 className="text-4xl font-black">{user?.balance.toLocaleString('pt-AO')} Kz</h3>
          </div>

          <div className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
            <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-4">Valor a Carregar</label>
            <div className="flex items-center gap-2">
              <input 
                type="number" 
                value={amount}
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            {[
              { id: 'express', name: 'Multicaixa Express', desc: 'Pagamento instantâneo via App', icon: <Smartphone />, color: 'bg-blue-50 text-blue-600' },
              { id: 'afrimoney', name: 'Afrimoney', desc: 'Carteira móvel Africell', icon: <Wallet />, color: 'bg-orange-50 text-orange-600' },
              { id: 'unitel', name: 'Unitel Money', desc: 'Carteira móvel Unitel', icon: <Smartphone />, color: 'bg-yellow-50 text-yellow-600' },
              { id: 'paypay', name: 'PayPay', desc: 'Pagamento digital PayPay', icon: <CreditCard />, color: 'bg-indigo-50 text-indigo-600' },
              { id: 'ekwanza', name: 'éKwanza', desc: 'Carteira digital éKwanza', icon: <Smartphone />, color: 'bg-emerald-50 text-emerald-600' }
            ].map((m, i) => (
              <button 
                key={i} 
                onClick={() => {
                  ...
                  handleDeposit(parseFloat(amount), m.name);
                }}
    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-8">
        <div className="bg-[#1A1A1A] p-8 rounded-[40px] text-white shadow-xl">
          <p className="text-[10px] font-black uppercase tracking-widest opacity-40 mb-2">Saldo para Saque</p>
          <h3 className="text-4xl font-black">{user?.balance.toLocaleString('pt-AO')} Kz</h3>
        </div>

        <div className="space-y-4">
          <label className="block text-[10px] font-black text-[#F23030] uppercase tracking-widest mb-2">Quanto deseja levantar?</label>
          <div className="relative bg-white p-6 rounded-[32px] border border-black/5 shadow-sm">
            <input 
              ...
              placeholder="0,00"
            />
            <span className="absolute right-8 top-1/2 -translate-y-1/2 font-black text-slate-300 text-2xl">Kz</span>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-4">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Enviar para Carteira</p>
          
          {[
            { name: 'Multicaixa Express', desc: 'Saque instantâneo', icon: <Smartphone />, color: 'bg-blue-50 text-blue-600' },
            { name: 'Afrimoney', desc: 'Carteira móvel Africell', icon: <Wallet />, color: 'bg-orange-50 text-orange-600' },
            { name: 'Unitel Money', desc: 'Carteira móvel Unitel', icon: <Smartphone />, color: 'bg-yellow-50 text-yellow-600' },
            { name: 'PayPay', desc: 'Carteira digital PayPay', icon: <CreditCard />, color: 'bg-indigo-50 text-indigo-600' },
            { name: 'éKwanza', desc: 'Carteira digital éKwanza', icon: <Smartphone />, color: 'bg-emerald-50 text-emerald-600' }
          ].map((m, i) => (
            <button key={i} className="flex items-center justify-between p-6 bg-white rounded-[32px] border border-black/5 hover:border-[#F23030] transition-all group active:scale-[0.98]">
              <div className="flex items-center gap-5">
                <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center", m.color)}>
                  {m.icon}
                </div>
  ...
  const renderContent = () => {
    switch (screen) {
      case 'SPLASH': return <Splash onComplete={() => setScreen('TERMS')} />;
      case 'TERMS': return renderTerms();
      case 'LOGIN': return renderLogin();
      case 'SIGNUP': return renderSignup();
      case 'DASHBOARD': return <Dashboard user={user!} setScreen={setScreen} />;
      case 'GROUPS': return <Groups groups={MOCK_GROUPS} onJoin={() => setScreen('VOTING')} onCreate={() => setScreen('CREATE_GROUP')} />;
      case 'CORPORATE': return <Corporate setScreen={setScreen} />;
      case 'NOTES': return <Notes />;
      case 'VOTING': return <Voting onBack={() => setScreen('DASHBOARD')} />;
      case 'SETTINGS': return <Settings user={user!} onLogout={() => { setUser(null); setScreen('LOGIN'); }} onBack={() => setScreen('DASHBOARD')} />;
      case 'CREATE_GROUP': return renderCreateGroup();
  ...
  return (
    <div className={cn("min-h-screen", theme === 'dark' ? "dark bg-[#1A1A1A] text-white" : "bg-[#F5F2ED]")}>
        ...
        <>
          <nav className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-black/5 px-8 py-4 flex justify-between items-center z-40 lg:hidden rounded-t-[40px] shadow-2xl">
            <button 
              ...
              className={cn("p-2 flex flex-col items-center gap-1", screen === 'DASHBOARD' ? "text-[#F23030]" : "text-slate-300")}
            >
              <Home size={26} />
            ...
            <button 
              ...
              className={cn("p-2 flex flex-col items-center gap-1", screen === 'GROUPS' ? "text-[#F23030]" : "text-slate-300")}
            >
              <Users size={26} />
            ...
            <button 
              ...
              className={cn("p-2 flex flex-col items-center gap-1", screen === 'NOTES' ? "text-[#F23030]" : "text-slate-300")}
            >
              <Book size={26} />
            ...
            <button 
              ...
              className={cn("p-2 flex flex-col items-center gap-1", screen === 'WITHDRAW' ? "text-[#F23030]" : "text-slate-300")}
            >
          ...
          <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-72 bg-white border-r border-black/5 flex-col p-8 z-40">
            ...
            <nav className="flex-1 space-y-2">
              {[
                ...
                { id: 'GROUPS', label: 'Grupos da Banda', icon: <Users size={22} /> },
                { id: 'CREATE_GROUP', label: 'Criar Kixikila', icon: <PlusCircle size={22} /> },
                { id: 'NOTES', label: 'Meu Caderno', icon: <Book size={22} /> },
                { id: 'WITHDRAW', label: 'Levantar Saque', icon: <ArrowUpRight size={22} /> },
                { id: 'CORPORATE', label: 'Corporativo', icon: <Building2 size={22} /> },
